...
::: notes
Podemos centralizar el control en [una pàgina](https://github.com/Som-Energia/somenergia-devupdater/blob/master/README.md#modules-status)
...
Multiversion python, solo la parte independiente del ERP
...
Intercoop es multi-versión de python y php.
:::
...
::: notes
- `*` puede ser `*args` si aceptamos posicionales arbitrarios
- Util: en `kwd` puede haber una `a`
:::
